...
final  String about;
 ...
 final User user;
  ...
  factory GetTeacherModel.fromMap(Map<String, dynamic> map) {
    return GetTeacherModel(
      id: map['id'] as int,
      ...
      is_followed: map['is_followed'] as bool,
  ...
  factory GetTeacherModel.fromJson(String source) => GetTeacherModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'GetTeacherModel(id: $id, about: $about, is_approved: $is_approved, user_id: $user_id, speciality_id: $speciality_id, created_at: $created_at, updated_at: $updated_at, is_followed: $is_followed, user: $user)';
  }

  @override
  bool operator ==(covariant GetTeacherModel other) {
