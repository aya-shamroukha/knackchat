...
final  String about;
 ...
 final User user;
  ...
  factory ShowTeacherModel.fromMap(Map<String, dynamic> map) {
    return ShowTeacherModel(
      id: map['id'] as int,
  ...
  factory ShowTeacherModel.fromJson(String source) => ShowTeacherModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'ShowTeacherModel(id: $id, about: $about, is_approved: $is_approved, user_id: $user_id, speciality_id: $speciality_id, created_at: $created_at, updated_at: $updated_at, is_followed: $is_followed, user: $user)';
  }

  @override
  bool operator ==(covariant ShowTeacherModel other) {
